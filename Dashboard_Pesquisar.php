...
<html>
<head>
<title> Dashboard Pesquisar </title>
</head>
...
<body>
	...
	if(isset($_POST['pesquisar-pessoa-post'])){
	...
	<?php
	 ...
	 ?>
    	...
    	<form action="Dashboard_Pesquisar.php" method="post">
            ...
            <button type="submit" name="pesquisar-pessoa-post">Pesquisar Pessoa</button>
            <br>
            <br>
            <br>
        </form>	
